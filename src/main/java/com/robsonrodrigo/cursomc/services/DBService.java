...
import com.robsonrodrigo.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Moda");
		Categoria cat4 = new Categoria(null, "Eletronicos");
		Categoria cat5 = new Categoria(null, "Perifericos");
		Categoria cat6 = new Categoria(null, "Decoracao");
		Categoria cat7 = new Categoria(null, "Acabamento");
		...
		categoriaRepository.save(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat6, cat7));
		...
		Cliente cli1 = new Cliente(null, "Ana Luiza", "defaultEmail", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("aninhasz"));
		...
		Pedido ped1 = new Pedido(null, sfd.parse("30/09/2017 20:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sfd.parse("10/10/2017 19:35"), cli1, e2);

		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sfd2.parse("20/10/2017"), null);
